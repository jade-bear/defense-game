...
const ImageLoader = {
  ...
  preload(onProgress, onComplete) {
    const list = [
      'guseul', 'awakened_guseul', 'meokbang', 'awakened_meokbang',
      'bulgeom', 'awakened_bulgeom', 'chonggeom', 'awakened_chonggeom',
      'villain_zombie', 'guseul_card', 'meokbang_card', 'bulgeom_card', 'chonggeom_card'
    ];
